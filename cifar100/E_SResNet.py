        ...
        if stride == 1:
            ...
            if anti_alias_layer is None:
                ...
                self.pad = layer.SeqToANNContainer(
                    StableReflectPad(padding=(1, 1, 1, 1))
                )
...
class ESResNet(nn.Module):
    ...
    def __init__(self, layers, in_chans=3, num_classes=100, zero_init_residual=False,
        ...
        self.layer1 = self._make_layer(BasicBlock, 64, layers[0], use_se=SE,
        ...
        self.layer3 = self._make_layer(BasicBlock, 256, layers[2], stride=2,
                                       dilate=replace_stride_with_dilation[1], use_se=SE, anti_alias_layer=anti_alias_layer)
