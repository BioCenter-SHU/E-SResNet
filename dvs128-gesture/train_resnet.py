...
from E_SResNet import E_SResNet_T
import autoaugment
_seed_ = 2025
import random
random.seed(2025)
...
def parse_args():
    ...
    parser.add_argument('--model', default='E_SResNet_T', help='model')
    ...
    parser.add_argument('--data-path', default='/path/to/your/DVSGesturedataset', help='dataset')
...
def main(args):
    ...
    if args.model == 'E_SResNet_T':
        model = E_SResNet_T(T=args.T, num_classes=args.num_classes, remove_model_jit=args.remove_model_jit, AA=args.AA, SE=args.SE)
    else:
